(function($) {
	...
	$('#main-page-form .findF input').on('change', function() {
   		var filterName = $(this).val();
		var test;
		$('.repl').each(function(){
			var origFilterName = $(this).find('input').attr('name');
			var spl = origFilterName.split('_');
			test = $(this).find('input').attr('name', filterName + '_' + spl[1]);
			console.log(test)
		})
